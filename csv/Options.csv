...
Storymap Test,,"For help, see tutorial in HandsOnDataViz.org"
Storymap Title,Leaflet Storymaps Demo,
Storymap Subtitle,Add subtitle here<br><small>Scroll down <i class='fa fa-chevron-down'></i></small>,"Add your subtitle, or delete that portion"
Storymap Logo,media/cthumanities-logo.png,Path to a logo image
Google Analytics Tracking ID,,Sample format: UA-5488840-29
Map Settings,,"For help, see tutorial in HandsOnDataViz.org"
Basemap Tiles,Stamen.Terrain,Drop-down menu for background basemap tiles
...
Author Name,Add Your Name,"Appears in map credits as ""View data by..."" (or leave blank)"
